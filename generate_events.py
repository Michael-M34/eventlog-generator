...
NO_SHOW_RESCHEDULED = [0.35, 0.65]

REMINDER_OF_PHOTOS = [0.75, 0.25]

CUSTOMER_AFTER_REMINDER = [0.25, 0.075, 0.675]

NEEDS_EDITING_INITIALLY = [0.25, 0.75]

NEEDS_TO_TALK_WITH_TECHNICIAN = [0.25, 0.75]

NEEDS_ANOTHER_TECHNICIAN_TALK = [0.1, 0.9]

PHOTOS_GETTING_PRINTED = [0.1, 0.9]

PHOTOS_GETTING_DIGITAL = [0.95, 0.05]

PHOTOS_PRINTED_DIGITAL_BOTH = [0.85, 0.1, 0.05]
...
# No show rebooking step outcomes
RESCHEDULED = 0
NOT_RESCHEDULED = 1
